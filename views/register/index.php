...
<div class="wrapper">
            ...
            <div class="main-center">
                <div class="login-box">
                    <div class="card card-outline card-primary">
                        ...
                        <a href="" class="h3"><b>AdminLTE</b></a>
                        </div>
                        <div class="card-body">
                        ...
                        <form id="register" method="post">
                            ...
                            <div class="input-group mb-3">
                            <input type="password" class="form-control"  name="password" id="showPassword" placeholder="Retype password" required>
                            <div class="input-group-append">
                                <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                                </div>
                        ...
                        <a href="../../views/login/index.php" class="text-center">I already have a membership</a>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <footer class="main-footer">
    <center>
    <strong>Copyright &copy; 2024 <a href="mailto:admin@mail.com">AdminLTE</a>.</strong>
    All rights reserved.
    </center>
  </footer>
